...
public class CompilerTest
{
	...
	public void test() throws Exception
	{
		...
		Assert.assertArrayEquals(array(0xB0, 0, 0, 0, 0xC0, 0x40, 0, 0),
				compile("IN ax out BX"));
		
		Assert.assertArrayEquals(array(
				0x70, 0, 0, 0xB, 0x81, 0x82, 0xF, 0x2F, 0x91, 0x82, 0xF, 0x2F, 0xA0, 1, 0, 0xB,
				0xB0, 0, 0, 0, 0xC0, 0x40, 0, 0),
			compile("JuMP 0xB jumpeq gX cx 0xF2F jumpgr Gx cx 0xF2F JuMPgrEQ ax bx 0xB IN ax out BX"));
